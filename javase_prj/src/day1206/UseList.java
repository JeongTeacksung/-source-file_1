...
//		//값 추가 : JDK 1.5이하에서는 객체로만 값을 추가할 수 있다.
...
//		list.add("김건하"); //Generic으로 설정된 형이 아닌 데이터형을 추가할 수 없다
	...
	/**
	 * ArrayList 사용 : Multi Thread환경에서 동시접근 가능(동기화 X)
	 */
	public void useArrayList() {
		//1. 생성
		ArrayList<String> al=new ArrayList<>();//방 0개
		List<String> al1=new ArrayList<>(100);// 방 100개
	...
	public void useVector() {
		...
		List<String> vec1=new Vector<>(100);// 방 100개
