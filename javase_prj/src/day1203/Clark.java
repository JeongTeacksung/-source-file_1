...
public final class Clark extends Person implements Fly{
	...
	public String eat(String menu, int price) {
		return getName()+"이 레스토랑에서 "+menu+"인 음식을 "+price+"$내고 먹는다.";
	}//eat

	@Override
	public String speed(String speed) {
		return getName()+"비행 속도가 "+speed+"하다";
	}//speed

	@Override
	public String height(String height) {
		return getName()+"비행 높이가 "+height+"하다";
	}//height
